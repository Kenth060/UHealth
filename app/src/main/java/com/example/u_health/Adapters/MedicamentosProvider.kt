...
class MedicamentosProvider
{
    companion object{
        ...
        var Recordatorios_Meds = mutableListOf<Medicamentos>(Medicamentos(1,"Ibuprofeno","2 veces al dia","3:00","3:00",30))
        var Recordatorios_Citas = mutableListOf<Citas>(Citas(1,"Ortopedia","Nahum Gutierrez","30/06/2023","15:00",""), Citas(2,"Medicina General","Joseph Rivas","30/06/2023","15:00",""))
